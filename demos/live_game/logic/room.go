...
type RoomData struct {
	...
	Players []PlayerData `json:"users"`
	Bubble  []BubbleData `json:"bombs"`
	Props   []PropData   `json:"properties"`
}
...
func (r *Room) JoinRobot(robot *Robot) {
	...
	robot.Player.room = r
	robot.Player.index = len(r.players)
...
func (r *Room) BroadcastMsg(msg *game.Message) {
...
func (r Room) SendPlayerMsg(p *Player, msg *game.Message) {
	p.SendMsg(msg)
